          ...
          <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr class="text-gray-700 dark:text-gray-400 ">
              ...
              <td class="px-4 py-3 text-xs">
                <span
                  class="px-2 py-1 font-semibold leading-tight text-red-600 bg-red-100 rounded-md dark:text-red-100 dark:bg-red-700">
                  {{ $item->status }}
                </span>
              </td>
              ...
              <td class="px-4 py-3">
                <div class="flex items-center space-x-4 text-sm">
                  ...
                  <a href="{{ route('pengaduans.show', $item->id)}} "
                    class="flex items-center justify-between  text-sm font-medium leading-5 text-yellow-500 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                    aria-label="Detail">
